               ...
               <asp:View ID="View1" runat="server">
                  <h3>Room Registration</h3>                                                   
                       ...
                       <table cellspacing="1" class="center">
                           ...
                           <tr><td></td></tr>
                           <tr>
                               <td class="auto-style8" style=" text-align: right;"><asp:Label ID="Label2" runat="server" Text="Room Type" Font-Bold="True"></asp:Label></td>
                               <td class="auto-style7" style=" text-align: left;"> <asp:DropDownList ID="roomtype_txt" runat="server" Width="322px">
                             ...
                             <tr><td></td></tr>
                           <tr>
                               <td class="auto-style8" style=" text-align: right;"><asp:Label ID="Label3" runat="server" Text="Room Rate" Font-Bold="True"></asp:Label></td>
                               <td class="auto-style7"  style=" text-align: left;"><asp:TextBox ID="roomrate_txt" runat="server"  Width="322px"></asp:TextBox></td>
                           </tr>
                             <tr><td></td></tr>
                            <tr>
                               <td class="auto-style8" style=" text-align: right;"><asp:Label ID="Label4" runat="server" Text="Select Date" Font-Bold="True"></asp:Label></td>
                               <td class="auto-style7"  style=" text-align: left;">   <asp:Calendar ID="regdate_txt" runat="server" align="center" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="200px">
                       ...
                       <table  cellspacing="1" class="center">
                           <tr>
                               <td style=" text-align: right;" class="auto-style10">
                                   <asp:Label ID="Label12" runat="server" Font-Bold="True" Text="Entry #"></asp:Label></td>
                               <td style=" text-align: left;">
                                   <asp:TextBox ID="entry_txt" runat="server" style="text-align: left" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               <td style=" text-align: right;" class="auto-style10">
                                   <asp:Label ID="Label11" runat="server" Font-Bold="True" Text="Name"></asp:Label>
                               </td>
                               <td style=" text-align: left;">
                                   <asp:TextBox ID="customer_txt" runat="server" style="text-align: left" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               <td style=" text-align: right;" class="auto-style10">
                                   <asp:Label ID="Label14" runat="server" Font-Bold="True" Text="Room Number"></asp:Label>

                               </td>
                               <td style=" text-align: left;">
                                   <asp:TextBox ID="customerRnumber_txt" runat="server" Enabled="False" style="text-align: left" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               ...
                               <td style=" text-align: left;">
                                    <asp:DropDownList ID="re_roomtype_txt" runat="server" Enabled="False" Width="322px">
                           <asp:ListItem>VIP</asp:ListItem>
                           <asp:ListItem>Single Bed</asp:ListItem>
                           <asp:ListItem>Double Bed</asp:ListItem>
                       </asp:DropDownList>
                           ...
                           <tr>
                               <td style=" text-align: right;" class="auto-style10">
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Text="No. of Customer"></asp:Label>
                               </td>
                               <td style=" text-align: left;">
                                       <asp:TextBox ID="re_customer_txt" runat="server" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               ...
                               <td style=" text-align: left;">  <asp:Calendar ID="re_checkin_dte" runat="server" align="center" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="200px">
                           <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                           <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                           <OtherMonthDayStyle ForeColor="#999999" />
                           <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
                           ...
                           <tr>
                               ...
                               <td style=" text-align: left;">
                                   <asp:TextBox ID="re_address_txt" runat="server" Width="322px"></asp:TextBox>
                           ...
                           <tr>
                               ...
                               <td style=" text-align: left;">
                                   <asp:TextBox ID="phonenumber_txt" runat="server" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               ...
                               <td style=" text-align: left;">
                                     <asp:TextBox ID="price_txt" runat="server" Enabled="False" Width="322px"></asp:TextBox>
                               </td>
                           </tr>
                             <tr><td></td></tr>
                           <tr>
                               ...
                               <td style=" text-align: left;">
                                     <asp:Button ID="btnadd_res" runat="server" BorderStyle="None" CssClass="w3-button w3-light-green" Text="Add New" />
                   <asp:Button ID="btnsave_reser" runat="server" BorderStyle="None" CssClass="w3-button w3-blue" Text="Reserve" />
                   <asp:Button ID="btnupdate_rserv" runat="server" BorderStyle="None" CommandArgument="View3" CommandName="SwitchViewByID" CssClass="w3-button w3-brown" Enabled="False" Text="Update" />
                   <asp:Button ID="btndelete_rserve" runat="server" BorderStyle="None" CssClass="w3-button w3-red " Enabled="False" Text="Delete" />
                   <asp:Button ID="Button1" runat="server" BorderStyle="None" CssClass="w3-button w3-light-blue " Enabled="False" Text="Cancel" />
                               </td>
                           </tr>
